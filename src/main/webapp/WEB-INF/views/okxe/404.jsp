  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 text-center mx-auto">
        <div class="404-img">
          <img src="${pageContext.request.contextPath}/resources/images/404/404.png" class="img-fluid" alt="404">
        </div>
        <div class="404-content">
          <h1 class="display-1 pt-1 pb-2">Oops</h1>
          <p class="px-3 pb-2 text-dark">${message}</p>
          <a href="${pageContext.request.contextPath}/okxe/home/index" class="btn btn-info">Back to home</a>
        </div>
      </div>
    </div>
  </div>
