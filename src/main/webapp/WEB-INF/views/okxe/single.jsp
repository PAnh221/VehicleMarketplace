                    ...
                    <div class="product-meta">
                        <ul class="list-inline">
                            <li class="list-inline-item"><i class="fa fa-user-o"></i> By <a
                                    href="${pageContext.request.contextPath}/okxe/userProfile/${seller.user_id}">${seller.name}</a>
                            </li>
                            <li class="list-inline-item"><i class="fa fa-folder-open-o"></i> Category<a
                                    href="${pageContext.request.contextPath}/okxe/brand">${brand.brandname}</a></li>
                            <li class="list-inline-item"><i class="fa fa-location-arrow"></i>
                                Location ${seller.location}</li>
                        </ul>
                    </div>

                    <div class="product-slider">
                        <div class="product-slider-item my-4"
                             data-image="${pageContext.request.contextPath}/images/bikes/${bike.bike_id}/${bike.bike_id}.png">
                            <img class="img-fluid w-100"
                                 src="${pageContext.request.contextPath}/resources/images/bikes/${bike.bike_id}/${bike.bike_id}.png"
                                 alt="product-img">
                        </div>
                        <div class="product-slider-item my-4"
                             data-image="${pageContext.request.contextPath}/images/bikes/${bike.bike_id}/${bike.bike_id}.png">
                ...
                <div class="sidebar">
                    ...
                    <div class="widget user text-center">
                        <img class="rounded-circle img-fluid mb-5 px-5"
                             src="${pageContext.request.contextPath}/resources/images/user/user-thumb.jpg" alt="">
                        <h4>
                            <a href="${pageContext.request.contextPath}/okxe/home/userProfile/${seller.user_id}">${seller.name}</a>
                        </h4>
