...
<section class="blog section">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/post-1.jpg" alt="article-01">
	</div>
	<!-- Post Title -->
	...
	<!-- Read more button -->
	<a href="${pageContext.request.contextPath}/okxe/home/singleBlog" class="btn btn-transparent">Read More</a>
</article>
				<!-- Article 02 -->
				<article>
					<div class="post-slider">
					  <div class="item"><img src="${pageContext.request.contextPath}/resources/images/blog/post-2.jpg" alt="Slider-Img-01"></div>
					  <div class="item"><img src="${pageContext.request.contextPath}/resources/images/blog/post-5.jpg" alt="Slider-Img-02"></div>
					  <div class="item"><img src="${pageContext.request.contextPath}/resources/images/blog/post-3.jpg" alt="Slider-Img-03"></div>
					</div>
					<h3>Donec id dolor in erat imperdiet.</h3>
					<ul class="list-inline">
						<li class="list-inline-item">by <a href="${pageContext.request.contextPath}/okxe/home/userProfile">Admin</a></li>
				...
				<article>
					<div class="video overly">
						<img src="${pageContext.request.contextPath}/resources/images/blog/post-3.jpg" alt="video-thumbnail">
						<div class="video-button video-box" data-video-url="https://www.youtube.com/embed/g3-VxLQO7do?autoplay=1">
							<span><img src="${pageContext.request.contextPath}/resources/images/blog/video-icon.png" alt="video-icon"></span>
						</div>
					</div>
					<h3>Donec id dolor in erat imperdiet.</h3>
					<ul class="list-inline">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/post-4.jpg" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/post-5.jpg" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
...
<!-- google map -->
<script src="${pageContext.request.contextPath}/resources/https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU" defer></script>
