...
<section class="blog section">
	...
	<ul class="list-inline">
		<li class="list-inline-item">by <a href="user-profile.jsp">Admin</a></li>
	...
	<!-- Read more button -->
	<a href="single-blog.jsp" class="btn btn-transparent">Read More</a>
</article>
				<!-- Article 02 -->
				<article>
				...
				<div class="sidebar">
					...
					<div class="widget category">
						...
						<ul class="category-list">
							<li><a href="category.jsp">Appearel <span class="float-right">(2)</span></a></li>
							<li><a href="category.jsp">Accesories <span class="float-right">(5)</span></a></li>
							<li><a href="category.jsp">Business<span class="float-right">(7)</span></a></li>
							<li><a href="category.jsp">Entertaiment<span class="float-right">(3)</span></a></li>
							<li><a href="category.jsp">Education<span class="float-right">(9)</span></a></li>
						</ul>
					</div>
					<!-- Archive Widget -->
					<div class="widget archive">
						...
						<ul class="archive-list">
							<li><a href="ad-list-view.jsp">January 2017</a></li>
							<li><a href="ad-list-view.jsp">February 2017</a></li>
							<li><a href="ad-list-view.jsp">March 2017</a></li>
							<li><a href="ad-list-view.jsp">April 2017</a></li>
							<li><a href="ad-list-view.jsp">May 2017</a></li>
						</ul>
					</div>
				</div>
			</div>
