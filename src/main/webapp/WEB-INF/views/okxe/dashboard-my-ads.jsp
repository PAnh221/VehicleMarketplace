					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<li class="nav-item dropdown dropdown-slide active">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item @@terms" href="${pageContext.request.contextPath}/okxe/home/terms-condition">Terms &amp; Conditions</a></li>
							</ul>
						</li>
			...
			<div class="col-lg-4">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li class="active">
								<a href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds"><i class="fa fa-user"></i> My Ads</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/okxe/home/dashboardFavouriteAds"><i class="fa fa-bookmark-o"></i> Favourite Ads <span>5</span></a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/okxe/home/dashboardArchivedAds"><i class="fa fa-file-archive-o"></i>Archeved Ads <span>12</span></a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds"><i class="fa fa-bolt"></i> Pending Approval<span>23</span></a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/okxe/home/index"><i class="fa fa-cog"></i> Logout</a>
							</li>
							<li>
			...
			<div class="col-lg-8">
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="View" class="view" href="${pageContext.request.contextPath}/okxe/home/category">
													<i class="fa fa-eye"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Edit" class="edit" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">
													<i class="fa fa-pencil"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Delete" class="delete" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">
				...
				<div class="pagination justify-content-center">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
								</a>
							</li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">1</a></li>
							<li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">2</a></li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">3</a></li>
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds" aria-label="Next">
			...
			<div class="col-lg-2 offset-lg-1 col-md-3 col-6 mb-4 mb-lg-0">
				<div class="block">
					...
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/okxe/home/terms-condition">Terms & Conditions</a></li>
					</ul>
				</div>
			</div>
			<!-- Link list -->
