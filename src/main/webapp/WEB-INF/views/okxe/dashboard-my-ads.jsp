						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item activePage" href="dashboard.jsp">Dashboard</a></li>
									<li><a class="dropdown-item active" href="dashboard-my-ads.html">Dashboard My Ads</a></li>
				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<li>
								<a href="dashboard-favourite-ads.jsp"><i class="fa fa-bookmark-o"></i> Favourite Ads <span>5</span></a>
							</li>
							<li>
								<a href="dashboard-archived-ads.jsp"><i class="fa fa-file-archive-o"></i>Archeved Ads <span>12</span></a>
							</li>
							<li>
								<a href="dashboard-pending-ads.jsp"><i class="fa fa-bolt"></i> Pending Approval<span>23</span></a>
							</li>
							<li>
