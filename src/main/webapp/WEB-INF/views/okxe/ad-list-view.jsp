...
<div class="widget category-list">
	...
	<ul class="category-list">
		<li><a href="category.jsp">New York <span>93</span></a></li>
		<li><a href="category.jsp">New Jersy <span>233</span></a></li>
		<li><a href="category.jsp">Florida  <span>183</span></a></li>
		<li><a href="category.jsp">California <span>120</span></a></li>
		<li><a href="category.jsp">Texas <span>40</span></a></li>
		<li><a href="category.jsp">Alaska <span>81</span></a></li>
	</ul>
</div>
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="category.jsp"><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a href="category.jsp" class="text-info"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="single.jsp" class="font-weight-bold">11inch Macbook Air</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
                            <li class="list-inline-item"><a href="category.jsp"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
        ...
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="single.jsp" class="font-weight-bold">Study Table Combo</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
                            <li class="list-inline-item"><a href="category.jsp"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
                            <li class="list-inline-item"><a href="category.htm"><i class="fa fa-calendar"></i>26th December</a></li>
