					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto main-nav ">
							<li class="nav-item @@home">
								<a class="nav-link" href="${pageContext.request.contextPath}/okxe/home/indexcontactUs">Home</a>
							</li>
...
<div class="widget category-list">
	...
	<ul class="category-list">
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">New York <span>93</span></a></li>
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">New Jersy <span>233</span></a></li>
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">Florida  <span>183</span></a></li>
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">California <span>120</span></a></li>
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">Texas <span>40</span></a></li>
		<li><a href="${pageContext.request.contextPath}/okxe/home/category">Alaska <span>81</span></a></li>
	</ul>
</div>
...
<div class="widget product-shorting">
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="${pageContext.request.contextPath}/okxe/home/category"><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a href="${pageContext.request.contextPath}/okxe/home/category" class="text-info"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="${pageContext.request.contextPath}/okxe/home/single">
                <img src="${pageContext.request.contextPath}/resources/images/products/products-1.jpg" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="${pageContext.request.contextPath}/okxe/home/single" class="font-weight-bold">11inch Macbook Air</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
                            <li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
                            <li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"><i class="fa fa-calendar"></i>26th December</a></li>
                        </ul>
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="${pageContext.request.contextPath}/okxe/home/single">
                <img src="${pageContext.request.contextPath}/resources/images/products/products-2.jpg" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="${pageContext.request.contextPath}/okxe/home/single" class="font-weight-bold">Study Table Combo</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
							<li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
							<li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"><i class="fa fa-calendar"></i>26th December</a></li>
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="${pageContext.request.contextPath}/okxe/home/single">
                <img src="${pageContext.request.contextPath}/resources/images/products/products-3.jpg" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="${pageContext.request.contextPath}/okxe/home/single">
                <img src="${pageContext.request.contextPath}/resources/images/products/products-4.jpg" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
        ...
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
							<a href="${pageContext.request.contextPath}/okxe/home/single" class="font-weight-bold">11 inch macbook air</a>
						</div>
						<ul class="list-inline mt-2 mb-3">
							<li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
							<li class="list-inline-item"><a href="${pageContext.request.contextPath}/okxe/home/category"><i class="fa fa-calendar"></i>26th December</a></li>
				...
				<div class="pagination justify-content-center py-4">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/ad-list-view" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
								</a>
							</li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/ad-list-view">1</a></li>
							<li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/ad-list-view">2</a></li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/ad-list-view">3</a></li>
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/ad-list-view" aria-label="Next">
