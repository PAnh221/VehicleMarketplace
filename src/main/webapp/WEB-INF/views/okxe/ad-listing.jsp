                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item dropdown dropdown-slide @@listing">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item @@listView" href="${pageContext.request.contextPath}/okxe/home/adVistView">Ad-List View</a></li>
                        ...
                        <ul class="navbar-nav ml-auto mt-10">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white add-button" href="${pageContext.request.contextPath}/okxe/home/ad-listing"><i class="fa fa-plus-circle"></i> Add Listing</a>
                            </li>
                        </ul>
                    </div>
                </nav>
