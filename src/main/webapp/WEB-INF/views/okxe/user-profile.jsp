                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="widget personal-info">
                            ...
                            <form action="${pageContext.request.contextPath}/okxe/user/updateUserProfile" method="post">
                                <input hidden="hidden" name="id" type="text" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" id="last-name"
                                           value="${user.getName()}">
                                </div>
                                <!-- File chooser -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone" type="text" class="form-control" id="comunity-name"
                                           value="${user.getPhone()}">
                                </div>
                                <!-- Checkbox -->
