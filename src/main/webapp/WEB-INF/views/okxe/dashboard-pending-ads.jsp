                            ...
                            <li class="nav-item dropdown dropdown-slide @@dashboard">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item @@dashboardPage"
                                           href="${pageContext.request.contextPath}/okxe/home/dashboard">Dashboard</a>
                                    </li>
                                    <li><a class="dropdown-item @@dashboardMyAds"
                                           href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds">Dashboard
                                        My Ads</a></li>
                                    <li><a class="dropdown-item @@dashboardFavouriteAds"
                                           href="${pageContext.request.contextPath}/okxe/home/dashboardFavouriteAds">Dashboard
                                        Favourite Ads</a></li>
                                    <li><a class="dropdown-item @@dashboardArchivedAds"
                                           href="${pageContext.request.contextPath}/okxe/home/dashboardArchivedAds">Dashboard
                                        Archived Ads</a></li>
                                    <li><a class="dropdown-item @@dashboardPendingAds"
                                           href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">Dashboard
                                        Pending Ads</a></li>
                                    ...
                                    <li class="dropdown dropdown-submenu dropright">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdown0501">
                                            <li><a class="dropdown-item"
                                                   href="${pageContext.request.contextPath}/okxe/home/index">Submenu
                                                01</a></li>
                                            <li><a class="dropdown-item"
                                                   href="${pageContext.request.contextPath}/okxe/home/index">Submenu
                                                02</a></li>
                            ...
                            <li class="nav-item dropdown dropdown-slide active">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item active"
                                           href="${pageContext.request.contextPath}/okxe/home/aboutUs">About Us</a></li>
                                    <li><a class="dropdown-item @@contact"
                                           href="${pageContext.request.contextPath}/okxe/home/contactUs">Contact Us</a>
                                    </li>
                                    <li><a class="dropdown-item @@profile"
                                           href="${pageContext.request.contextPath}/okxe/home/userProfile">User
                                        Profile</a></li>
                                    <li><a class="dropdown-item @@404"
                                           href="${pageContext.request.contextPath}/okxe/home/404">404 Page</a></li>
                                    <li><a class="dropdown-item @@package"
                                           href="${pageContext.request.contextPath}/okxe/home/package">Package</a></li>
                                    <li><a class="dropdown-item @@singlePage"
                                           href="${pageContext.request.contextPath}/okxe/home/single">Single Page</a>
                                    </li>
                                    <li><a class="dropdown-item @@store"
                                           href="${pageContext.request.contextPath}/okxe/home/store">Store Single</a>
                                    </li>
                                    <li><a class="dropdown-item @@blog"
                                           href="${pageContext.request.contextPath}/okxe/home/blog">Blog</a></li>
                                    <li><a class="dropdown-item @@singleBlog"
                                           href="${pageContext.request.contextPath}/okxe/home/singleBlog">Blog
                                        Details</a></li>
                                    <li><a class="dropdown-item @@terms"
                                           href="${pageContext.request.contextPath}/okxe/home/termsCondition">Terms
                                        &amp; Conditions</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown dropdown-slide @@listing">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item @@category"
                                           href="${pageContext.request.contextPath}/okexe/home/category">Ad-Gird
                                        View</a></li>
                                    <li><a class="dropdown-item @@listView"
                                           href="${pageContext.request.contextPath}/okexe/home/adListView">Ad-List
                                        View</a></li>
                        ...
                        <ul class="navbar-nav ml-auto mt-10">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white add-button"
                                   href="${pageContext.request.contextPath}/okxe/home/adListing"><i
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <div class="widget user-dashboard-profile">
                        ...
                        <a href="${pageContext.request.contextPath}/okexe/home/userProfile" class="btn btn-main-sm">Edit
                            Profile</a>
                    </div>
                    <!-- Dashboard Links -->
                    <div class="widget user-dashboard-menu">
                        <ul>
                            <li class="active"><a href="${pageContext.request.contextPath}/okexe/home/dashboardMyAds"><i
                                    class="fa fa-user"></i> My Ads</a></li>
                            <li><a href="${pageContext.request.contextPath}/okexe/home/dashboardFavouriteAds"><i
                                    class="fa fa-bookmark-o"></i> Favourite Ads
                                <span>5</span></a></li>
                            <li><a href="${pageContext.request.contextPath}/okexe/home/dashboardArchivedAds"><i
                                    class="fa fa-file-archive-o"></i>Archived Ads
                                <span>12</span></a></li>
                            <li><a href="${pageContext.request.contextPath}/okexe/home/dashboardPendingAds"><i
                                    class="fa fa-bolt"></i> Pending Approval<span>23</span></a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/okxe/home/index"><i class="fa fa-cog"></i>
                                Logout</a></li>
