				...
				<nav class="navbar navbar-expand-lg navbar-light navigation">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<li class="nav-item dropdown dropdown-slide @@listing">
							...
							<!-- Dropdown list -->
							<ul class="dropdown-menu">
								<li><a class="dropdown-item @@category" href="${pageContext.request.contextPath}/okexe/home/category">Ad-Gird View</a></li>
								<li><a class="dropdown-item @@listView" href="${pageContext.request.contextPath}/okexe/home/adListView">Ad-List View</a></li>
			...
			<div class="col-lg-8">
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Edit" class="edit" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">
													<i class="fa fa-pencil"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Delete" class="delete" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">
				...
				<div class="pagination justify-content-center">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
								</a>
							</li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">1</a></li>
							<li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">2</a></li>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds">3</a></li>
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/okxe/home/dashboardPendingAds" aria-label="Next">
