			...
			<div class="col-lg-4">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li><a href="${pageContext.request.contextPath}/okxe/home/dashboardMyAds"><i class="fa fa-user"></i> My Ads</a></li>
							<li class="active">
								...
								<td class="action" data-title="Action">
									<div class="">
										<ul class="list-inline justify-content-center">
											...
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Delete" class="delete" href="${pageContext.request.contextPath}/okxe/home/dashboardFavouriteAds">
