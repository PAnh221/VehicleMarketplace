						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="dashboard-favourite-ads.html">Dashboard Favourite Ads</a></li>
			...
			<div class="col-lg-4">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li><a href="dashboard-my-ads.jsp"><i class="fa fa-user"></i> My Ads</a></li>
							<li class="active">
